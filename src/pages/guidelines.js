        ...
        <Hero color="#263238">
          ...
          <section className="block">
            <div class="notification is-primary has-text-centered">
              ガイドライン範囲外の特殊な用途での利用をご検討の方は、ご予算や利用方法をご提示の上で<Link to="/about">お問い合わせフォーム</Link>からご相談ください。
            </div>
          </section>
          ...
          <section className="block">
            ...
            <ol>
              <li>動画の場合、1秒毎に5000円。秒数は小数点以下を切り上げして計算します。</li>
              <li>写真やスクリーンショットの場合、1枚あたりに20000円。</li>
              <li>音声のみの場合、1秒毎に2000円。秒数は小数点以下を切り上げして計算します。</li>
              <li>上記合計金額に10%の消費税が発生します。</li>
